...
import ServicesCard, { ServicesCardProp } from "./ServicesCard";
...
const Services: FC = () => {
  const services: ServicesCardProp[] = [
    ...
    },
    {
      ...
      body: "We help find your target audience. Why should we bother looking at your page?",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2rem"
    ...
    {
      title: "Creative ads",
      body: "How to present your product and business. Is it worth knowing who you are?",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2rem"
    ...
    },
    {
      ...
      body: "What is my business about? Should I have multiple side hustles? Or focus on a few?",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2rem"
    ...
    },
    {
      ...
      body: "How much should I spend on marketing? If I spend this much, how many people will I reach?",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2rem"
